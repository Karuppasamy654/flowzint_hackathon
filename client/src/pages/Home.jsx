...
const localTexts = {
    en: {
        ...
        desc: 'FlowZint is a real-time AI-powered crisis response network that reduces help response time from hours to seconds by intelligently matching people in need with the right volunteers.',
    ...
    hi: {
        ...
        desc: 'फ़्लोज़िंट एक वास्तविक समय का एआई-संचालित संकट प्रतिक्रिया नेटवर्क है जो सहायता प्रतिक्रिया समय को घंटों से घटाकर सेकंड कर देता है।',
    ...
    ta: {
        ...
        title2: 'ஒன்றாக வளர்க.',
        desc: 'ஃப்ளோசிண்ட் என்பது ஒரு நிகழ்நேர AI-இயங்கும் அவசர கால உதவி அமைப்பாகும், இது உதவி நேரத்தை மணிக்கணக்கில் இருந்து வினாடிகளாக குறைக்கிறது.',
