...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen w-full bg-surface flex flex-col items-center justify-center py-10 px-4">
      {/* Brand logo header */}
      <Link href="/" className="mb-6 flex items-center select-none gap-0.5">
        <span className="text-3xl font-display font-semibold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-violet-500">
          Help
        </span>
        <span className="text-3xl font-extrabold text-indigo-600">Net</span>
      </Link>
