...
const helpers = [
  {
    id: uuidv4(), name: 'Dr. Priya Sharma', email: 'priya@demo.com',
  ...
  {
    id: uuidv4(), name: 'Rahul Verma', email: 'rahul@demo.com',
    password: bcrypt.hashSync('demo123', 10),
    location: { lat: 28.6280, lng: 77.2195, label: 'Rajiv Chowk, Delhi' },
  ...
  {
    id: uuidv4(), name: 'Ananya Gupta', email: 'ananya@demo.com',
    password: bcrypt.hashSync('demo123', 10),
  ...
  {
    id: uuidv4(), name: 'Vikram Singh', email: 'vikram@demo.com',
    password: bcrypt.hashSync('demo123', 10),
  ...
  {
    id: uuidv4(), name: 'Sneha Patel', email: 'sneha@demo.com',
    password: bcrypt.hashSync('demo123', 10),
  ...
  {
    id: uuidv4(), name: 'Arjun Reddy', email: 'arjun@demo.com',
    password: bcrypt.hashSync('demo123', 10),
  ...
  {
    id: uuidv4(), name: 'Meera Iyer', email: 'meera@demo.com',
    password: bcrypt.hashSync('demo123', 10),
  ...
  {
    id: uuidv4(), name: 'Karan Malhotra', email: 'karan@demo.com',
    password: bcrypt.hashSync('demo123', 10),
  ...
  {
    id: uuidv4(), name: 'Divya Nair', email: 'divya@demo.com',
    password: bcrypt.hashSync('demo123', 10),
  ...
  {
    id: uuidv4(), name: 'Rohan Kapoor', email: 'rohan@demo.com',
    password: bcrypt.hashSync('demo123', 10),
  ...
  {
    id: uuidv4(), name: 'Aisha Khan', email: 'aisha@demo.com',
    password: bcrypt.hashSync('demo123', 10),
  ...
  {
    id: uuidv4(), name: 'Sanjay Mehta', email: 'sanjay@demo.com',
    password: bcrypt.hashSync('demo123', 10),
  ...
  {
    id: uuidv4(), name: 'Tanya Joshi', email: 'tanya@demo.com',
    password: bcrypt.hashSync('demo123', 10),
  ...
  {
    id: uuidv4(), name: 'Nikhil Bansal', email: 'nikhil@demo.com',
    password: bcrypt.hashSync('demo123', 10),
  ...
  {
    id: uuidv4(), name: 'Pooja Agarwal', email: 'pooja@demo.com',
    password: bcrypt.hashSync('demo123', 10),
...
module.exports = { helpers, communities, institutions };
